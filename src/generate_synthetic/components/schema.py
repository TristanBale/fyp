...
'''
    ...
    Schema to format the synthetic dataset with Petastorm
'''
import numpy as np
...
ShapeSchema = Unischema(
    ...
    [
        ...
        UnischemaField("target_ratio", np.string_, (), ScalarCodec(StringType()), False),
        ...
        UnischemaField("f_sine_ratio", np.float32, (), ScalarCodec(IntegerType()), False),
    ],
)